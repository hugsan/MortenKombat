...
public class MageOne extends SpellCaster {
    ...
    public MageOne(Stage s){
        ...
        attack = AnimationCreator.createAnimation("assets/fightingscreen/Heroes/NinjaB Attack.png", 0.14f,1,20);
        iddle = AnimationCreator.createAnimation("assets/fightingscreen/Heroes/NinjaB Idle.png", 0.14f, 1, 20);
        dead = AnimationCreator.createAnimation("assets/fightingscreen/Heroes/NinjaB Dead.png", 0.14f, 1, 20);
